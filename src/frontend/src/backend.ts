...
export class Backend implements backendInterface {
    ...
    async deleteContactSubmission(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getContactSubmissionById(arg0: bigint): Promise<ContactSubmission | null> {
        if (this.processError) {
            try {
    ...
    async getROILeads(): Promise<Array<ROILead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getROILeads();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitROILead(arg0: string, arg1: string, arg2: string, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitROILead(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
